...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:140px"><img src="images/logo-negro-lineal.png"></td>
			...
			<td style="background-color:white; width:150px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					<br>
					Dirección: Doceava Avenida Sur Prolongación Blvd. Akishino
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					<br>
					Teléfono: 962 214 4484
					
					<br>
					dulceriayeshuaoficial@gmail.com
