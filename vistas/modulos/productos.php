...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="inicio"><i class="fa fa-dashboard"></i> Incio</a></li>
        ...
        <table class="table table-bordered table-striped dt-responsive tablaProductos" width="100%">
          ...
          <thead>
            ...
            <tr>
              ...
              <th style="width: 10px">Agregado</th>
      ...
      <div class="modal-body">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="panel">SUBIR IMAGÉN</div>

            <input type="file" class="nuevaImagen" name="nuevaImagen">

            <p class="help-block">Peso máximo de la imagén 2MB</p>
             ...
             <div class="form-group row">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control input-lg" id="editarPrecioVenta" name="editarPrecioVenta" step="any" readonly required>
